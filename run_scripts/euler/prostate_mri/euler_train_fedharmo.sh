...
#SBATCH --output=logs_pyfed/config.prostate_mri.fedharmo_prostate_trial0.out
...
python main.py --config 'config.prostate_mri.fedharmo' \
               --server 'euler' \
               --trial $trial \
               --train_ratio $train_ratio \
               --run_name 'fedharmo_ratio_'$train_ratio'trial_'$trial \
               --run_notes 'trial '$trial': fedharmo' \
               --exp_name 'fedharmo'